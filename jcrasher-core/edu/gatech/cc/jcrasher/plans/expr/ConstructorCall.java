 ...
 */
public class ConstructorCall<T> implements FunctionCall<T> {
  ...
  public String toString(final Class<?> testee) {
    ...
    if (needsEnclosingInstance()) {
      notNull(enclosedBy);
      res.append("("+enclosedBy.toString(testee)+").");
    }
    ...
    final String className =
        CodeGenFct.getName(constructor.getDeclaringClass(), testee); 
  ...
  public String toString() {
    return toString(constructor.getDeclaringClass());
  }  
}
